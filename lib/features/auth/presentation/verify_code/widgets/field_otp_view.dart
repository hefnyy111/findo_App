...
class FieldOtpView extends StatelessWidget {
  ...
  FieldOtpView({required this.startIndex,required this.endIndex, required this.currentBorderr});
        ...
        child: Shimmer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: cubitVerify.currentBorder == currentBorderr ? Border.all(color: AppColors.kPrimaryColor, width: 2) : Border.all(color: AppColors.kbackgroundColor, width: 2), // بوردر عريض
