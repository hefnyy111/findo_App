...
class FieldOtpView extends StatelessWidget {
  ...
  FieldOtpView({required this.startIndex,required this.endIndex,});
    ...
    builder: (context, state) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.kPrimaryColor, width: 2), // بوردر عريض
...
Widget customField() {
  return Row(
      ...
      children: [
        FieldOtpView(startIndex: 0, endIndex: 3),
        SizedBox(width: 20,),
        FieldOtpView(startIndex: 3, endIndex: 6),
      ],
  );
}
